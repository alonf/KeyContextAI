...
- **Run**: `run-20260819-202406609-404c823c`
- **Harness**: `copilot-cli-file-primary`
- **Target digest**: `9803ff18a071c2e2ba5d60b08d532072ecfc9329`
- **Completion**: `none`
- **Verdict**: `failed`
...
Failure reason: verification-command-failed:specrew-governance:diagnostics-require-command-scoped-disclosure
