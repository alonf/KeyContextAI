...
- **Run**: `run-20260827-140159347-64828b6d`
- **Harness**: `codex-cli-file-primary`
- **Target digest**: `d579077e42231e0b1c68def1e8ede4bc93b1914f`
- **Completion**: `none`
- **Verdict**: `failed`
...
Failure reason: verification-target-digest-mismatch-before-execution
