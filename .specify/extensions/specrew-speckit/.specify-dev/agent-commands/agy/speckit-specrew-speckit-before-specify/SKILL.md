---
name: speckit-specrew-speckit-before-specify
description: Route the specify entry through the Specrew design workshop before producing
  a spec
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: specrew-speckit:commands/speckit.specrew-speckit.before-specify.md
---
