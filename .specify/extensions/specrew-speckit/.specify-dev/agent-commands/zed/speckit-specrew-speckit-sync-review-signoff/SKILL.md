...
description: Persist session-state metadata after review-signoff boundary work is
  committed
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: specrew-speckit:commands/speckit.specrew-speckit.sync-review-signoff.md
---
